...
import { Typography, List, ListItem, ListItemText, Alert, Divider } from '@mui/material'
                    ...
                    <List>
                        ...
                        <ListItem>
                            <ListItemText 
                                ...
                                secondary={t('inscription.create.step1.description')}
                            />
                        </ListItem>
                        ...
                        <ListItem>
                            <ListItemText 
                                ...
                                secondary={t('inscription.create.step2.description')}
                            />
                        </ListItem>
                        ...
                        <ListItem>
                            <ListItemText 
                                ...
                                secondary={t('inscription.create.step3.description')}
                            />
                        </ListItem>
                    </List>
                    ...
                    <List>
                        ...
                        <ListItem>
                            <ListItemText 
                                ...
                                secondary={t('inscription.modify.step1.description')}
                            />
                        </ListItem>
                        ...
                        <ListItem>
                            <ListItemText 
                                ...
                                secondary={t('inscription.modify.step2.description')}
                            />
                        </ListItem>
                    </List>
