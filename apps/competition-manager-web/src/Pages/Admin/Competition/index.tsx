...
import { faBasketShopping, faClock, faGears, faInfo, faTrophy, faUserCheck, faUsers, faUsersGear } from "@fortawesome/free-solid-svg-icons";
...
export const AdminCompetition = () => {
    ...
    const navItems = [
        ...
        { text: t('glossary:confirmations'), icon: faUserCheck, link: `/admin/competitions/${competitionEid}/confirmations` },
