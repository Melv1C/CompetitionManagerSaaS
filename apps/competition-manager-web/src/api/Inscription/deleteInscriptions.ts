 ...
 * ```
 */
export const deleteInscriptions = async (competitionEid: Eid, inscriptionEid: Eid): Promise<boolean> => {
    await api.delete(`/competitions/${competitionEid}/inscriptions/${inscriptionEid}`);
    return true;
} 