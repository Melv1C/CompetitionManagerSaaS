...
const DEV_TEAM = [
    {
        name: 'Claes Melvyn',
        linkedIn: 'https://www.linkedin.com/in/melvyn-claes-187820225/',
        email: 'claes.melvyn@gmail.com',
    },
    {
        name: 'Claes Riwan',
        linkedIn: 'https://www.linkedin.com/in/riwan-claes-a13224332/',
        email: 'riwan.claes@gmail.com',
    },
];
        ...
        >
            ...
            >
                <Typography variant="body2">
                    © {new Date().getFullYear()} Competition Manager.{' '}
                    {t('rightsReserved')}
                </Typography>
            </Box>
        </Box>
