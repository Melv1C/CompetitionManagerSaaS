...
import { AdminFromCompetiton$, Eid$ } from '@competition-manager/schemas';
...
router.delete(
    ...
    async (req: AuthenticatedRequest, res) => {
        try{
            ...
            if (!checkAdminRole('owner', req.user!.id, z.array(AdminFromCompetiton$).parse(competition.admins), res)) {
                return;
            }
